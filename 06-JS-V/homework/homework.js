...
function crearUsuario() {
  ...
  // con prototype: permite agregar una función al objeto una vez construido (de forma tardía)
...
// ---------------------------------------------------------------------------//
  ...
  function myPersonaTest(){
    juan = new Persona( 'Juan','Perez',32,'Río Ceballos')  
